...
public class OneToOneCRUDTest3 {
	...
	public void insertPerson() {
		EntityManagerFactory entityManagerFactory = 
				Persistence.createEntityManagerFactory("Myp"); //persistence.xml is read here 
	...
	void assignExistingPassportToExistingPerson()
	{
		...
		transaction.begin();
				...
				Person person 	  = entityManager.find(Person.class, 17);
				Passport passport = entityManager.find(Passport.class, 20);
	...
	public void insertNewPersonForExistingPassport() {
		...
		transaction.begin();
			...
			Passport passport = entityManager.find(Passport.class, 30);
