	...
	*/
	...
	public void insertDeptTest() {
		...
		transaction.begin();
			...
			dept.setDepartmentNumber(60); //these values might come from angular UI form
			dept.setDepartmentName("VolkswagenExam111");
			dept.setDepartmentLocation("OfflineMode221");
